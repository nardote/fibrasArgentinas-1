<template>
    <div class="container" >
        ...
        <form class="mt-3">
            ...
            <div class="mt-3">
                <label class="form-label">Imagen (Tamaño recomendado 165x170)</label>
...
export default {
    ...
    methods: {
        ...
        crearServicio() {
            ...
            axios.post('/api/crearClienteEmpresa', formData, {
                headers: {
                ...
                .then(response => {
                    ...
                    this.$store.commit('setMensajeAlerta', 'Cliente creado con éxito');
